...
CREATE TABLE `modules_settings` (
  ...
  `key` varchar(256) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
...
CREATE TABLE `module_contact_form` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `page_page_modules_id` int(11) unsigned NOT NULL,
  `email` varchar(256) COLLATE utf8_czech_ci DEFAULT NULL,
  `message_ok` varchar(256) COLLATE utf8_czech_ci NOT NULL DEFAULT 'Email byl odeslán.',
  PRIMARY KEY (`id`),
  KEY `page_page_modules_id` (`page_page_modules_id`),
...
CREATE TABLE `module_image_galery_images` (
  ...
  `page_page_modules_id` int(11) unsigned NOT NULL,
  `name` varchar(128) COLLATE utf8_czech_ci NOT NULL,
  `extension` varchar(4) COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `module_insert_code` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `page_page_modules_id` int(11) unsigned NOT NULL,
  `code` text CHARACTER SET utf16 COLLATE utf16_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
CREATE TABLE `module_pictograms` (
  ...
  `icon` varchar(64) CHARACTER SET utf8 COLLATE utf8_czech_ci NOT NULL,
  `link` text CHARACTER SET utf8 COLLATE utf8_czech_ci,
  PRIMARY KEY (`id`)
...
CREATE TABLE `module_reference` (
  ...
  `page_page_modules_id` int(11) unsigned NOT NULL,
  `title` varchar(512) COLLATE utf8_czech_ci NOT NULL,
  `subtitle` text COLLATE utf8_czech_ci,
  `text` text COLLATE utf8_czech_ci NOT NULL,
  `client` varchar(512) COLLATE utf8_czech_ci DEFAULT NULL,
  `link` varchar(256) COLLATE utf8_czech_ci DEFAULT NULL,
  `imagename` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
  `enabled` int(1) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
CREATE TABLE `page` (
  ...
  `seo_url_text` varchar(64) COLLATE utf8_czech_ci DEFAULT NULL,
  `final_url_text` text COLLATE utf8_czech_ci,
...
CREATE TABLE `redirections` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `from` varchar(512) COLLATE utf8_czech_ci NOT NULL,
  `to` varchar(512) COLLATE utf8_czech_ci NOT NULL,
  `code` varchar(3) COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
